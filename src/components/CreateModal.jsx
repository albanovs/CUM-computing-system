                ...
                <div className={`bg-white w-full max-w-md md:max-w-lg rounded-2xl shadow-xl overflow-auto animate-fade-in ${loading ? "pointer-events-none opacity-60" : ""}`}>
                    ...
                    <form onSubmit={handleSubmit} className="px-6 py-4 space-y-4 max-h-[70vh] overflow-y-auto">
                        <div className="flex gap-1">
                            <input name="id" placeholder="ID" value={form.id} onChange={handleChange} className="border p-2 w-full rounded focus:ring-2 focus:ring-green-400" disabled={loading} />
                        ...
                        <div className="flex gap-1">
                            ...
                            <input name="phoneNumber" placeholder="Телефон" value={form.phoneNumber} onChange={handleChange} className="border p-2 w-full rounded focus:ring-2 focus:ring-green-400" disabled={loading} />
                        </div>
                        <div className="flex gap-1">
                            <input name="phoneModel" placeholder="Модель телефона" value={form.phoneModel} onChange={handleChange} className="border p-2 w-full rounded focus:ring-2 focus:ring-green-400" disabled={loading} />
                            <input name="phonePrice" placeholder="Цена" type="number" value={form.phonePrice} onChange={handleChange} className="border p-2 w-full rounded focus:ring-2 focus:ring-green-400" disabled={loading} />
                        </div>
                    ...
                    <div className={`bg-white rounded-2xl shadow-lg w-full max-w-lg max-h-[80vh] flex flex-col animate-fade-in ${loading ? "pointer-events-none opacity-60" : ""}`}>
                        <div className="p-6 flex-1 flex flex-col overflow-hidden">
                            ...
                            <div className="flex justify-end gap-3 mt-4">
                                <button onClick={() => setShowPlan(false)} className="px-4 py-2 bg-gray-300 rounded-lg hover:bg-gray-400 transition" disabled={loading}>
                                    Назад
                                </button>
